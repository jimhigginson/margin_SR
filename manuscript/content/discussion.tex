...
Two related techniques were presented in the other two studies.
Both studies employed a fluorecent dye that was activated only in the presence of tumour.
...
5-ALA \cite{leunigFluorescenceStainingOral2001} and the gamma-gt spray were both interesting - these stains were both stains that contained a fluorescent dye that was activated only in the presence of tumour. 
