...
Despite these variations, the concept appears to have a consistent benefit for detection of disease, with a pooled sensitivity of \SI{95.7}{\percent}, and resolution able in some cases to identify otherwise undetectable satellite metastases \cite{voskuilf.j.ImageguidedSurgeryTumor2019}.
