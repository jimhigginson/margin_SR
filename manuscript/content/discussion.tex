...
5-ALA \cite{leunigFluorescenceStainingOral2001} and the gamma-gt spray \cite{slooterm.d.DetectingTumourpositiveResection2018} were both interesting - these stains were both stains that contained a fluorescent dye that was activated only in the presence of tumour. 
