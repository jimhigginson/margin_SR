...
DOR_model$data %>% 
  ...
  geom_vline(xintercept = exp(DOR_model$TE.random), linetype='dotted') +
  geom_abline()
  scale_x_log10() +
  theme_tufte()
  ggsave('funnel_plot.png')
```
This is similar to the inbuilt funnel, the main difference is the latter uses 'effective study size' (inverted) rather than precision:
...
print(export.table, file = '../manuscript/tables/study_details.tex')
```
