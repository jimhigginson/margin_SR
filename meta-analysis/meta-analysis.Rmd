...
ggplot(data = meta.data) +
  ...
  ylab('Sensitivity') + 
  annotate('text', x = 0.9, y = 0, label = str_interp("AUC = $[.3f]{AUC(fit)$AUC}")) +
  theme_clean()
...
ggplot() +
  ...
  geom_point(aes(fpr(frozen.data), sens(frozen.data), size = frozen.data$`Number of margins included`), shape = 1, alpha = 0.6) +
